...
public class JwtUtil {
    ...
    public String createToken(AuthDTO product) {
        Claims claims = Jwts.claims().setSubject(product.getEmail());
        claims.put("email",product.getEmail());
        claims.put("role",product.getRole());
